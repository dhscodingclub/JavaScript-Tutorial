function refreshLessonPage() {
    ...
    if (lessonNumber == 0) {
        ...
        <div class="code"><div><div class="keyword">var</div> x = 5;</div>
        <div>x = x + 6;</div>
        <div><div class="class">console</div>.log(x);</div>
        <div>--> 11</div></div>
        ...
        <div class="code">
        <div><div class="keyword">var</div> x = 5;</div>
        <div><div class="keyword">var</div> y = 3;</div>
        <div>if (x > y){</div>
        ...
        <div class="code"><div class="keyword">var</div> x = 1;</div>
        <div class="code">while(x < 6){</div>
        <div class="code">&emsp;<div class="class">console</div>.log(x); </div>   
        ...
        lessonSection.innerHTML =
            ...
            <div class="code"><div class="keyword">var</div> x = 0;</div>
            <div class="code"><div class="control>while</div> (x < 8) {</div>
            ...
            <div class="code"><div class="control>for</div>(<div class="keyword">var</div> x = 0; x < 8; x=x+1) {</div>
            <div class="code">&emsp; //do something</div>
            <div class="code">}</div>
            ...
            <div class="code"><div class="control>for</div>(<div class="keyword">var</div> x = 0; x < 8; x++) {</div>
            <div class="code">&emsp; //do something</div>
            <div class="code">}</div>
        ...
        <div class="code">}</div>
        <div class="code"><div class="class">console</div>.log(triangleArea(10, 12));</div>
        ...
        <div class="code"><div class="control>if</div> (x < 10 && y == 3) //True</div>
        <div class="code"><div class="control>if</div> (x == 5 || y == 5) //False</div>
        <div class="code"><div class="control>if</div> !(x == y) //True</div>
        ...
        <div class="code">&emsp; <div class="keyword">var</div> count = 0;</div>
        <div class="code">&emsp; for (i=0; i < word.length; i++) {</div>
        <div class="code">&emsp; &emsp;<div class="control>if</div> (word[i] == "a" || word[i] == "e" || word[i] == "i" || word[i] == "o" || word[i] == "u") {</div>
        ...
        <div class="code"><div class="keyword">var</div> name = "Adam Clark";</div>
        <div class="code"><div class="keyword">var</div> age = '35';</div>
        <div class="code"><div class="class">console</div>.log(name + ' is ' + age);</div>
        ...
        <div class="code"><div class="keyword">var</div> string = 'supercalifragilisticexpialidocious';</div>
        <div class="code"><div class="class">console</div>.log(string.length);</div>
        ...
        <div class="code"><div class="class">console</div>.log("helloworld".indexOf("w");</div>
        ...
        <div class="code"><div class="keyword">var</div> array = ['red', 'orange', 'yellow', 'green', 'blue', 'indigo', 'violet'];</div>
        <div class="code"><div class="class">console</div>.log(array[4]);</div>
        ...
        <div class="code"><div class="class">console</div>.log(array);</div>
        <div class="code"><div class="class">console</div>.log(array.length) //print length of array;</div>
        ...
        <div class="code"><div class="keyword">var</div> person = { </div>
        ...
        <p>In the above code, we create a new class that we call Car. Car has a constructor, which is the method used to create new objects that are based on the class. The constructor has two paramaters, which are name and year. Within the constructor, we make the objects properties of the two parameters: name and year. You can create a new object based on class car by using the new keyword, followed by the class name, and passing in the paramaters for the constructor to "construct" the new object which is an instance of the class. Here is an example:</p>
            ...
            <div class="code">&emsp; }</div>
            <div class="code">};</div>
            <div class="code"><div class="keyword">var</div> Ford = new Car("Ford Raptor", 2018);</div>
            <div class="code"><div class="class">console</div>.log(Ford.name);</div>
            <div class="code"><div class="class">console</div>.log(Ford.year);</div>
        ...
        <div class="code">class Car {</div>
            ...
            <div class="code">&emsp; &emsp; <div class="class">console</div>.log(this.name);</div>
            <div class="code">&emsp; &emsp; <div class="class">console</div>.log(this.year);</div>
            <div class="code">&emsp; }</div>
            <div class="code">};</div>
            <div class="code"><div class="keyword">var</div> Ford = new Car("Ford Raptor", 2018);</div>
        ...
        <h2>Tell your instructor you have completed your lessons</h2>
        </div>
        `;

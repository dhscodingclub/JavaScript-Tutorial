function refreshLessonPage() {
    ...
    if (lessonNumber == 0) {
        ...
        <div class="code">padding-left:8em;if (word[i] == letter) {</div>
        <div class="code">padding-left:12em;letter_count = letter_count + 1;</div>
        <div class="code">padding-left:8em;}</div>
